 ...
 */
@Entity
@Table(name = "alq_hunter", indexes = {})
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@JsonIgnoreProperties(value = { "hibernateLazyInitializer", "handler", "fieldHandler" })
public class Hunter extends IdEntity {
	...
	private Subject subject;// 所属专题分类id
	...
	private String sendStartTime; //接单开始时间
	private String sendEndTime; //接单关闭时间
	...
	@JoinColumn(name = "background_attachment_id")
