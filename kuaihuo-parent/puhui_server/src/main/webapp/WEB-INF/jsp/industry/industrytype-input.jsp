...
function addMore(){
	...
	$(".adds").append("<tr id='shanchu"+sum+"'><td bgcolor='#ececec' width='33%' align='right' ><span style='font-size: 13px; color: rgb(2, 48, 97);'>二级行业分类名称：</span></td><td><input id='iconname"+ sum +"' value='${icon.name}'required='required' validType='length[1,10]' invalidMessage='行业名称必须在1到10之间，请重新输入' missingMessage='请输入行业名称' name='secondType["+sec+"].name' class='easyui-validatebox' type='text' style='width: 160px;' /> <input type='button' class='TianJia5' onclick='deleteAdds(this,\"shanchu"+sum+"\")' value=' - 删除'></td></tr>");
...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',split:true" style="width: 300px">
		...
		<form id="addtypeform" method="post" action="${ctx}/pc/after/industry/industrytype-add">
				...
				<table style="width:400px;"  class="adds">
					<tr>
						...
						<td>
							...
							id="industrytypeUrlfile" /> <!-- <a
							href="javascript:$('#industrytypeUrlfile').uploadify('upload');">上传文件</a> <a
							href="javascript:$('#industrytypeUrlfile').uploadify('cancel');">取消上传队列</a> -->
							<div id="result">
