...
<script type="text/javascript">
	 ...
	 function userQuery() {
		$('#industryassociationcashreceivestationTable').datagrid("reload", {
...
<table id="industryassociationcashreceivestationTable" class="easyui-datagrid" border="0" fit="true"
	data-options="fitColumns:true,idField:'id',method:'get',pageList:[10,20,30,50],rownumbers:true,singleSelect:false,url:'${ctx}/pc/after/cashreceivestation/industryassociation_cashreceivestation_list_data',toolbar:'#industryassociationTool',pagination:true">
	<thead>
		<tr>
			...
			<th data-options="field:'status'" width="80" align="center" formatter="viewStatus">订单状态</th>
