...
public class Tls_sigature {
	...
	public String getUserSign(String admin) {
		...
		try {
			...
			initParams.init();
			// 私钥
			String privStr = (String) initParams.getProperties().get("PH_IM_PRIVSTR");
			// 公钥
			String pubStr = (String) initParams.getProperties().get("PH_IM_PUBSTR");
			//Integer appid=(Integer) initParams.getProperties().get("PH_IM_SDKAPPID");
