 ...
 * @作者：杨颜光
 *
 * @创建时间：2017年5月12日 上午11:27:48
 *
 * @Copyright by杨颜光
 */
@Table(name="ph_product_sku_snapshot")
public class ProductSkuSnapshot implements Serializable{

	private static final long serialVersionUID = 2347781794046901427L;
