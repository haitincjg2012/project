 ...
 * @version: 2.1
 */
public class AgentDTO extends BaseValidate implements Serializable {
    /**
	 * 
	 */
    ...
    private List<AgentImageDTO> agentImageDTOList;
  //扩展代理表 -- 2017-6-29 何文浪
    private List<AgentVO> agentVoList;
    public List<AgentImageDTO> getAgentImageDTOList() {
        return agentImageDTOList;
    }

    public void setAgentImageDTOList(List<AgentImageDTO> agentImageDTOList) {
